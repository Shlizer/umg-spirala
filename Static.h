...
namespace CONFIG {
	...
	**/
	 ...
	 *  F O N T   S C A L E S
	**/
	const int FONT_SCALE_LOGO_INIT = 0;
	const int FONT_SCALE_LOGO_MENU_UP = 0;
	const int FONT_SCALE_LOGO_MENU_DOWN = 0;
	const int FONT_SCALE_LOGO_GAMEPLAY = 0;
